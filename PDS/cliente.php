...
<head>
    ...
    <?php 
        ...
        if($paranetro){
            $dados = mysql_query("select * from CLIENTE where like nome '$parametro'");

        } else {
            $dados = mysql_query("select * from CLIENTE "); 
        }
    ...
    <table class="table table-striped" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a class="btn btn-primary btn-xs" href="<?php echo "CLIENTEForm.php?id=". $linha['id']  ?>">Editar</a>                
                    <a class="btn btn-danger btn-xs" href="#" data-toggle="modal"  href="<?php echo "BuilderCLIENTE.php?id=". $linha['id']  ?>">Excluir</a>
                </td>
            </tr>
            <?php 
